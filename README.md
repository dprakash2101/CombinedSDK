...
```sh
pip install git+https://github.com/dprakash2101/CombinedSDK.git
```
(you may need to run `pip` with root permission: `sudo pip install git+https://github.com/dprakash2101/CombinedSDK.git`)
...
*EmployeeApi* | [**employee_get**](docs/EmployeeApi.md#employee_get) | **GET** /employee | 
*EmployeeApi* | [**employee_id_delete**](docs/EmployeeApi.md#employee_id_delete) | **DELETE** /employee/{id} | 
*EmployeeApi* | [**employee_id_get**](docs/EmployeeApi.md#employee_id_get) | **GET** /employee/{id} | 
*EmployeeApi* | [**employee_id_put**](docs/EmployeeApi.md#employee_id_put) | **PUT** /employee/{id} | 
*EmployeeApi* | [**employee_post**](docs/EmployeeApi.md#employee_post) | **POST** /employee | 
